...
class ItemsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $item = Item::create([
            ...
            'image_path' => 'images/Onion-Bundle.jpg',
            'condition_id' => 3,
        ]);
        ...
        $item = Item::create([
            ...
            'image_path' => 'images/Leather-Shoes.jpg',
            'condition_id' => 4,
        ]);
        $item->categories()->attach([1, 5]); // ファッション, メンズ
        ...
        $item = Item::create([
            ...
            'image_path' => 'images/Microphone.jpg',
            'condition_id' => 2,
        ]);
        $item->categories()->attach([2]); // 家電
        ...
        $item = Item::create([
            ...
            'image_path' => 'images/Coffee-Grinder.jpg',
            'condition_id' => 1,
        ]);
        $item->categories()->attach([10]); // キッチン
        ...
        $item = Item::create([
            ...
            'image_path' => 'images/cosmetics.jpg',
            'condition_id' => 2,
        ]);
